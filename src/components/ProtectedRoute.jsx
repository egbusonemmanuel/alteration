    ...
    if (!isApprovedEmail) {
      return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4 animate-fade-in">
          <div className="text-6xl font-black text-gold/20 mb-4">403</div>
      ...
      return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 animate-fade-in">
          <div className="glass-card p-10 max-w-md w-full text-center">
            <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(212,175,55,0.2)]">
              <Lock className="text-gold w-8 h-8" />
            </div>
            <h2 className="text-2xl font-black tracking-tighter uppercase mb-2 text-gold-gradient">RESTRICTED ACCESS</h2>
            ...
            <form onSubmit={handleUnlock} className="flex flex-col gap-4">
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 focus:outline-none focus:border-gold transition-colors text-ivory text-center tracking-[0.2em]"
              />
